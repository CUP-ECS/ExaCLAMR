    ...
    namespace Impl
    {
        ...
        struct ViewMapping<
            ...
            private:
                ...
                ( rank <= 2 && R0 && std::is_same<typename SrcTraits::array_layout, Kokkos::LayoutHilbert>::value ) ), typename SrcTraits::array_layout, Kokkos::LayoutStride>::type array_layout;
