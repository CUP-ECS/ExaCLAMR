...
int main( int argc, char* argv[] ) {
    ...
    // using cell_array = Cajita::Array<double, Cajita::Cell, Cajita::UniformMesh<double>, Kokkos::LayoutHilbert>;
    ...
    // std::shared_ptr<cell_array> height = Cajita::createArray<double, Kokkos::LayoutHilbert> ( "height", cell_scalar_layout );
    // std::shared_ptr<cell_array> height = Cajita::createArray<double>( cell_scalar_layout, HilbertArray );
